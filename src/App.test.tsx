...
test('useEffect should delete expired todos', async () => {
	...
	const textField = await screen.findByPlaceholderText('Enter a new todo');
	const expiryDateField = await screen.findByPlaceholderText('Enter expiry date and time');
